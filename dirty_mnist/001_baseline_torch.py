...
trainset = MnistDataset('../dacon_data/dirty/train', '../dacon_data/dirty_mnist_answer.csv', transforms_train)
testset = MnistDataset('../dacon_data/dirty/test', '../dacon_data/sample_submission.csv', transforms_test)
...
if __name__ == '__main__':
    ...
    # 저장함
    submit.to_csv('../dacon_data/submit0223.csv', index=False)